...
| In VSCode use Debugger and list, show two distinct example examples of dictionaries, show Keys/Values using debugger. | This show two dictionarys of cards, with atributes such as rarity and elixer cost. <img src="https://tanayshah1.github.io/student2/images/4.png" alt="Description of Image"/> |
...
| In JavaScript code, describe fetch and method that obtained the Array of JSON objects. | This fetches the variable API endpoint, that will change depending on what chest you click on. <img src="https://tanayshah1.github.io/student2/images/12.png" alt="Description of Image"/> If the Gold chest is clicked on, it goes to the common chest API, and if the Legendary chest is clicked it fetches its respective API. Here is that code <img src="https://tanayshah1.github.io/student2/images/13.png" alt="Description of Image"/> |
